...
import nl.knaw.huc.di.rd.tag.creole.Constructors.annotation
import nl.knaw.huc.di.rd.tag.creole.Constructors.atom
import nl.knaw.huc.di.rd.tag.creole.Constructors.attribute
import nl.knaw.huc.di.rd.tag.creole.Constructors.choice
import nl.knaw.huc.di.rd.tag.creole.Constructors.concur
...
import nl.knaw.huc.di.rd.tag.creole.Constructors.element
...
import nl.knaw.huc.di.rd.tag.creole.Constructors.oneOrMore
import nl.knaw.huc.di.rd.tag.creole.Constructors.optional
import nl.knaw.huc.di.rd.tag.creole.Constructors.partition
...
import nl.knaw.huc.di.rd.tag.creole.NameClasses.anyNameExcept
import nl.knaw.huc.di.rd.tag.creole.NameClasses.name
import nl.knaw.huc.di.rd.tag.creole.NameClasses.nameClassChoice
import nl.knaw.huc.di.rd.tag.creole.NameClasses.nsName
import nl.knaw.huc.di.rd.tag.creole.NameClasses.nsNameExcept
import nl.knaw.huc.di.rd.tag.creole.patterns.Patterns
