...
import nl.knaw.huc.di.rd.tag.creole.Basics.id
import nl.knaw.huc.di.rd.tag.creole.Basics.qName
import nl.knaw.huc.di.rd.tag.creole.events.EndTagCloseEvent
import nl.knaw.huc.di.rd.tag.creole.events.EndTagOpenEvent
import nl.knaw.huc.di.rd.tag.creole.events.Events.endAnnotationCloseEvent
import nl.knaw.huc.di.rd.tag.creole.events.Events.endAnnotationOpenEvent
import nl.knaw.huc.di.rd.tag.creole.events.Events.startAnnotationCloseEvent
import nl.knaw.huc.di.rd.tag.creole.events.Events.startAnnotationOpenEvent
import nl.knaw.huc.di.rd.tag.creole.events.Events.textEvent
import nl.knaw.huc.di.rd.tag.creole.events.StartTagCloseEvent
import nl.knaw.huc.di.rd.tag.creole.events.StartTagOpenEvent
